...
class Database():
    ...
    def __create_connection(self):
        try:
            ...
            cursor.execute('CREATE TABLE IF NOT EXISTS posts (id BIGINT(20), author_id BIGINT(20), title VARCHAR(255) DEFAULT NULL, content VARCHAR(255), privacy VARCHAR(255) DEFAULT "all", timestamp BIGINT(20))')
